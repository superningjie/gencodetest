 ...
 * Author: liebin.zheng
 * Generate Date: 2024-10-28 10:10:18
 */
...
public final class CosmicLauncher {
	...
	private static final String PROJECT_HOME = "E:/project/test1";
...
//			setMqConsumerRegister(false, null);
			...
			setConfigUrl("172.20.106.77:2181");
			setMcServerUrl("http://172.20.106.77:8090");
			setFsServerUrl("172.20.106.77", 8100);
			setImageServerUrl("172.20.106.77", 8100);
//	        setEnableLightWeightDeploy(true);
			setDubboHostConfig(LOCAL_IP, 28888, 30880);
//	        set("login.type", "STANDALONE");
//			setMqConsumerRegister(false, null);
