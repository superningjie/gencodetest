...
public class PartyRepository {
     ...
     */
    //TODO 改为要读取的查询配置编码
    private static final HRBaseServiceHelper HELPER = new HRBaseServiceHelper("hspm_dwhquery");
    ...
    private static void andCommonFilter(FilterInfo filterInfo, QFilter filter) {
        ...
        QFilter commonFilter = (QFilter) filterInfo.getCommFilter().get("hspm_dwhquery");
    ...
    private static void andDataRuleFilter(QFilter filter) {
        //TODO "hspm_qbggquery 改为要读取的查询配置编码
        QFilter dataRuleFilter = (QFilter) HRMServiceHelper.invokeHRMPService("hrcs", "IHRCSDataPermissionService", "getDataRule", new Object[]{RequestContext.get().getCurrUserId(), "1WXBPN7+OHJZ", "hspm_dwhquery", "47150e89000000ac", Collections.emptyMap()});
