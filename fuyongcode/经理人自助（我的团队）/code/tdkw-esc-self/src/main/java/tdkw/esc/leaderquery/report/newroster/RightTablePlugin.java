...
public class RightTablePlugin extends AbstractReportListDataPlugin {
    ...
    //todo 假实体待建
    private static final String entryNumber = "tdkw_roster_pc";
...
//        DataSet finish = queryBatchData(queryParam);
//        List<Object> ids = ORM.create().toPlainDynamicObjectCollection(finish).stream().map(i -> i.get("ermanfileid")).collect(Collectors.toList());
//        logger.info("ids" + ids);
//        DataSet batchBy = buildBatchDataSet(ids);
//        byBatchInfo.setMaxRowCountCached(100000);
//        long end = System.currentTimeMillis();
//        logger.info("在职人员花名册报表queryBatch查询共耗时:" + (end - start) + "毫秒");
//        return batchBy;
//    }
...
//        erManFileDataSet = hrpi_empposorgrel.leftJoin(erManFileDataSet).on("person.number", "person.number").select("tdkw_personid","ermanfileid", "tdkw_companyrpt", "tdkw_personrpt", "tdkw_positionrpt", "sortcode", "isprimary", "newname", "startdate", "enddate", "person.name", "tdkw_adminrpt", "tdkw_postype", "tdkw_versionnumber").finish();
//        select("tdkw_genderrpt", "tdkw_birthdayrpt", "fpersonid", "tdkw_agerpt", "workplace",  "tdkw_marriagestatusrpt", "graduateschoolid", "tdkw_schoolname", "schoolrecord", "tdkw_educationrpt", "tdkw_majorrpt", "tdkw_politicalstatusrpt", "tdkw_socialworkagerpt").finish();
...
//        List<FilterItemInfo> filterItems = reportQueryParam.getFilter().getFilterItems();
        ...
        logger.info("查询数据" + ORM.create().toPlainDynamicObjectCollection(finish.copy()));
        //岗位标签特殊处理
       /* QFilter jobfQfilter = new QFilter("iscurrentversion", QCP.equals, "1");
        ...
        finish = finish.leftJoin(jobfDataSet).on("jobfid", "id").select(new String[]{"tdkw_adminrpt", "ermanfileid", "startdate", "enddate", "tdkw_companyrpt", "tdkw_personrpt", "tdkw_positionrpt", "tdkw_postlevelrpt", "tdkw_employtyperpt", "sortcode", "tdkw_personid", "tdkw_engagedindustry", "isprimary",  "newname", "tdkw_marriagestatusrpt", "graduateschool.id as tdkw_collegerpt", "tdkw_schoolname", "schoolrecord", "tdkw_educationrpt", "tdkw_politicalstatusrpt", "tdkw_socialworkagerpt", "tdkw_comsercountrpt", "tdkw_serviceyearrpt", "tdkw_genderrpt", "tdkw_addressrpt", "tdkw_birthdayrpt", "tdkw_agerpt", "personid", "jobfid", "tdkw_majorrpt", "tdkw_postype", "tdkw_versionnumber"}, new String[]{"jobfname"}).finish();
    ...
    private void getHasRightOrg(QFilter orgQfilter) {
        ...
        logger.info("在职人员花名册报表是否有所有权限:" + hasAllOrgPerm);
        if (!hasAllOrgPerm) {
