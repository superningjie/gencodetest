...
public class DisciplineTablePlugin extends AbstractReportListDataPlugin {
    private static final Log logger = LogFactory.getLog(DisciplineTablePlugin.class);
    //todo 假实体待建
    private static final String entryNumber = "tdkw_disciplineinspec_pc";
    //一次性展示200条数据
    ...
    /**
     * @param ：任职信息维护-人员id-人事业务档案-员工任职-所属公司-行政组织名称；当前生效的主要任职 姓名：任职信息维护-员工-姓名
     *                                                       纪委组织：任职信息维护-任职组织-名称；取任职组织的所属组织类型为“纪”的数据。
     *                                                       纪委职务：任职信息维护-任职职务-名称；取任职组织的所属组织类型为“纪”的数据。
     *                                                       任职开始日期：任职信息维护-任职开始时间
     *                                                       任职结束日期：任职信息维护-任职结束时间
     *                                                       性别：任职信息维护-人员id-人员非时序性属性-性别-名称
     *                                                       籍贯：任职信息维护-人员id-基本信息补充-籍贯
     *                                                       婚姻状况：任职信息维护-人员id-人员时序性属性-婚姻状况-名称
     *                                                       学历：任职信息维护-人员id-教育经历-学历-名称；取最高学历
     *                                                       政治面貌：任职信息维护-人员id-基本信息补充-政治面貌-名称
     *                                                       出生日期：任职信息维护-人员id-人员非时序性属性-出生日期
     *                                                       年龄：任职信息维护-人员id-人员非时序性属性-年龄
     *                                                       工龄：任职信息维护-人员id-人员非时序性属性-社会工龄
     *                                                       集团司龄：任职信息维护-人员id-人员非时序性属性-司龄
     *                                                       过滤之前的报表数据查询
     * @return
     */
    private DataSet queryData(ReportQueryParam reportQueryParam) {
        ...
        //查询任职经历
        //DataSet empposorgrelDataSet = QueryServiceHelper.queryDataSet(algoKey, "hrpi_empposorgrel", "person.id," +"company", new QFilter[]{personQfilter, eduQfilter}, null);
        //查服务年限
    ...
    private QFilter getHasRightOrg(QFilter orgQfilter) {
        ...
        logger.info("领导查询-纪检委报表是否有所有权限:" + hasAllOrgPerm);
        if (!hasAllOrgPerm) {
    ...
    private static void versionControl(QFilter eduQfilter, QFilter perTsPropQfilter,
        ...
        //其他任职信息
        otherEmpFilter.and("tdkw_dgtjorg.tdkw_basedatafield.number", QCP.equals, "XY004");
