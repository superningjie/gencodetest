...
//        erManFile.and("empposrel.businessstatus", QCP.equals, "1");
        ...
        DataSet hspm_ermanfile = ORM.create().queryDataSet(algoKey, "hspm_ermanfile", "person,empposrel.company," +
                "person.name,empposrel.position,empposrel.tdkw_postlevel,empposrel.tdkw_employtype," +
                "pernontsprop.gender,pernontsprop.age,empposrel.adminorg,tdkw_index,empposrel.adminorg.sortcode", new QFilter[]{personFiler, erManFile});
        ...
        // 服务年限基础页面
        DataSet hrpi_perserlen = ORM.create().queryDataSet(algoKey, "hrpi_perserlen", "person,joincomdate,tdkw_newjointime,socialworkage",
        ...
        // 基本信息表单
        DataSet hspm_personinfo = ORM.create().queryDataSet(algoKey, "hspm_personinfo", "person,tdkw_progressbar",
        ...
        //人员非时序性属性
        DataSet hrpi_pernontsprop = ORM.create().queryDataSet(algoKey, "hrpi_pernontsprop", "person,tdkw_origin.tdkw_address,tdkw_full_pinyin_name as pinyin",
                new QFilter[]{personFiler, personInfoFilter});
        DataSet finish = hspm_ermanfile.leftJoin(hrpi_perregion).on("person", "person").select("person", "empposrel.company", "empposrel.adminorg.sortcode", "politicalstatus.name",
                "person.name", "empposrel.position", "empposrel.tdkw_postlevel", "empposrel.tdkw_employtype", "tdkw_index",
        ...
        finish = finish.leftJoin(hrpi_perserlen).on("person", "person").select("person", "empposrel.company as tdkw_company", "empposrel.adminorg as tdkw_dept", "empposrel.adminorg.sortcode", "politicalstatus.name",
                "person.name as tdkw_name", "empposrel.position as tdkw_position", "empposrel.tdkw_postlevel as tdkw_postlevel",
                "empposrel.tdkw_employtype as tdkw_employtype", "tdkw_index",
                ...
                "joincomdate as tdkw_joincomdate", "tdkw_newjointime as tdkw_comsercount", "socialworkage as tdkw_socialworkage").finish();
        finish = finish.leftJoin(hspm_personinfo).on("person", "person").select("person", "tdkw_company", "empposrel.adminorg.sortcode", "politicalstatus.name",
                "person as tdkw_person", "tdkw_name", "tdkw_position", "tdkw_postlevel", "tdkw_employtype", "tdkw_gender", "tdkw_age", "tdkw_index",
                "tdkw_politicalstatus", "tdkw_marriagestatus", "tdkw_education", "tdkw_graduateschool", "graduateschool.name", "schoolrecord", "tdkw_major",
                "tdkw_joincomdate", "tdkw_comsercount", "tdkw_socialworkage", "tdkw_progressbar", "tdkw_dept").finish();
        finish = finish.leftJoin(hrpi_pernontsprop).on("person", "person").select("person", "tdkw_company", "empposrel.adminorg.sortcode", "politicalstatus.name",
                "person as tdkw_person", "tdkw_name", "tdkw_position", "tdkw_postlevel", "tdkw_employtype", "tdkw_gender", "tdkw_age", "tdkw_index",
                "tdkw_origin.tdkw_address as tdkw_nativeplace", "tdkw_politicalstatus", "tdkw_marriagestatus", "tdkw_education", "tdkw_graduateschool", "graduateschool.name", "schoolrecord", "tdkw_major",
                "tdkw_joincomdate", "tdkw_comsercount", "tdkw_socialworkage", "tdkw_progressbar", "tdkw_dept", "pinyin").finish();
    ...
    public static DataSet queryPersonInfoDep(List<Long> personIds, String algoKey) {
        ...
        DataSet hspm_ermanfile = ORM.create().queryDataSet(algoKey, "hspm_ermanfile", "person,person.number,empposrel.company," +
                "person.name,empposrel.position,empposrel.tdkw_postlevel,empposrel.tdkw_employtype,empposrel.adminorg.sortcode," +
        ...
        QFilter personFlow = new QFilter("tdkw_changetype.id", QCP.in, idList).and("depemp.isprimary", QCP.equals, "1");
        DataSet hpfs_personflow1 = ORM.create().queryDataSet(algoKey, "hpfs_personflow", "id,flowtime,person,tdkw_changereason,tdkw_changetype,depemp,laborreltype,employee", new QFilter[]{personFiler, personFlow});
        ...
        DataSet hpfs_personflow = ORM.create().queryDataSet(algoKey, "hpfs_personflow", "id,person,tdkw_changereason,tdkw_changetype,depemp,laborreltype,employee", new QFilter("id", QCP.in, personFlowIds).toArray());
//        DataSet hpfs_personflow = ORM.create().queryDataSet(algoKey, "hpfs_personflow", "flowtime,person,tdkw_changereason,tdkw_changetype,depemp,laborreltype,employee", new QFilter[]{personFiler, personFlow});
        ...
        hpfs_personflow = hpfs_personflow.leftJoin(quitfileDataSet).on("employee", "employee.id").select("id", "flowtime", "person", "tdkw_changereason", "tdkw_changetype", "depemp", "laborreltype", "employee").finish();
        ...
        // 服务年限基础页面
        DataSet hrpi_perserlen = ORM.create().queryDataSet(algoKey, "hrpi_perserlen", "person,joincomdate,tdkw_newjointime,comsercount,socialworkage",
                new QFilter[]{personFiler, perserlenFilter});
        ...
        DataSet hspm_personinfo = ORM.create().queryDataSet(algoKey, "hspm_personinfo", "person,tdkw_progressbar",
                new QFilter[]{personFiler, personInfoFilter});
        //人员非时序性属性
        DataSet hrpi_pernontsprop = ORM.create().queryDataSet(algoKey, "hrpi_pernontsprop", "person,tdkw_origin.tdkw_address",
                new QFilter[]{personFiler, personInfoFilter});
        ...
        finish = finish.leftJoin(hpfs_personflow).on("person", "person").select("person", "empposrel.company", "empposrel.adminorg.sortcode", "person.number",
                ...
                "laborreltype", "depemp", "flowtime", "tdkw_changetype", "tdkw_changereason").finish();
        ...
        finish = finish.leftJoin(hrpi_perserlen).on("person", "person").select("person", "empposrel.company as tdkw_company", "empposrel.adminorg.sortcode", "person.number",
                "person.name as tdkw_name", "empposrel.position as tdkw_position", "empposrel.tdkw_postlevel as tdkw_postlevel",
                "empposrel.tdkw_employtype as tdkw_employtype",
                "pernontsprop.gender as tdkw_gender", "pernontsprop.age as tdkw_age",
                "politicalstatus as tdkw_politicalstatus", "marriagestatus as tdkw_marriagestatus", "education as tdkw_education",
                "joincomdate as tdkw_joincomdate", "tdkw_newjointime as tdkw_comsercount", "socialworkage as tdkw_socialworkage",
                "employee as tdkw_employee", "laborreltype as tdkw_laborreltype", "depemp as tdkw_depemp", "flowtime as tdkw_flowtime", "tdkw_changetype", "tdkw_changereason").finish();
        finish = finish.leftJoin(hspm_personinfo).on("person", "person").select("tdkw_flowtime", "person", "tdkw_company", "empposrel.adminorg.sortcode", "person.number",
                "tdkw_name", "tdkw_position", "tdkw_postlevel", "tdkw_employtype", "tdkw_gender", "tdkw_age",
                "tdkw_politicalstatus", "tdkw_marriagestatus", "tdkw_education",
                "tdkw_joincomdate", "tdkw_comsercount", "tdkw_socialworkage", "tdkw_progressbar", "tdkw_employee", "tdkw_laborreltype",
                "tdkw_depemp", "tdkw_changetype", "tdkw_changereason").finish();
        finish = finish.leftJoin(hrpi_pernontsprop).on("person", "person").select("tdkw_flowtime", "person", "tdkw_company", "empposrel.adminorg.sortcode", "person.number",
                "tdkw_name", "tdkw_position", "tdkw_postlevel", "tdkw_employtype", "tdkw_gender", "tdkw_age",
                "tdkw_origin.tdkw_address as tdkw_nativeplace", "tdkw_politicalstatus", "tdkw_marriagestatus", "tdkw_education",
                "tdkw_joincomdate", "tdkw_comsercount", "tdkw_socialworkage", "tdkw_progressbar", "tdkw_employee", "tdkw_laborreltype",
                "tdkw_depemp", "tdkw_changetype", "tdkw_changereason").finish();
    ...
    public static DataSet getPersonInfoIntegrity(QFilter filter, String algoKey) {
        ...
        DataSet hspm_ermanfile = ORM.create().queryDataSet(algoKey, "hspm_ermanfile", "person,person.id,empposrel.company," +
                "person.name, empposrel.tdkw_sectorid.name as tdkw_sectorid.name," +
                "empposrel.adminorg,empposrel.adminorg.id as adminorg.id, empposrel.position.name as position.name, empposrel.tdkw_ranks.number as tdkw_ranks.number,empposrel.tdkw_employtype.number as tdkw_employtype.number", new QFilter[]{filter});
        ...
        DataSet finish = hspm_ermanfile.leftJoin(hspm_personinfo).on("person", "person").select("person", "person.id", "empposrel.company as tdkw_company",
                "person.name", "adminorg.id", "position.name", "tdkw_ranks.number", "tdkw_sectorid.name", "tdkw_employtype.number", "empposrel.adminorg as tdkw_dept", "tdkw_progressbar").finish();
        finish = finish.leftJoin(hrpi_empentrel).on("person", "person").select("person", "person.id", " tdkw_company",
                "person.name", "adminorg.id", "position.name", "tdkw_ranks.number", "tdkw_sectorid.name", "tdkw_employtype.number", " tdkw_dept", "tdkw_progressbar", "laborrelstatus.number").finish();
        finish = finish.distinct();
