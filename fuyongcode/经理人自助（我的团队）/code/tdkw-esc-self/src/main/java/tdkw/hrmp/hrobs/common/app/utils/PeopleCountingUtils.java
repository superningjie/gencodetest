package tdkw.hrmp.hrobs.common.app.utils;
...
import tdkw.hrmp.hrobs.common.app.mobie.WorkTypeFilterUtils;
...
//        QFilter filter = new QFilter("person.id", QCP.in, personIds);
    ...
    public static List<DynamicObject> getPersonsIds(String pkOrg, Date endDate, List<Object> postGradeList, List<Object> psNclList, String algoKey, String highLevelType) {
        ...
        erManFilePersonIds = WorkTypeFilterUtils.filterWorkType(erManFilePersonIds, highLevelType);
        // 人员任职经历
    ...
    public static DynamicObjectCollection getPersonsByEndDate(String pkOrg, Date endDate, List<Object> postGradeList, List<Object> psNclList, String algoKey, String highLevelType) {
        ...
        // 人事业务档案
        List<Long> erManFileIds = PeopleCountingUtils.getAllErManFileByPersonIds(filter);
        erManFileIds = WorkTypeFilterUtils.filterWorkType(erManFileIds, highLevelType);
...
//        filter.and("empposrel.businessstatus", QCP.equals, "1");
    ...
    /**
     * @description 获取权限组织并且存入缓存(tdkw.common.app - 人员分析专用)
     * @author xxx
     * @date 2023/10/16
     */
    public static Map<String, Object> getAdminOrg() {
        ...
        // 获取缓存中的权限组织
        String adminOrgIdsStr = HRUserRoleCacheUtils.getCache(String.valueOf(currentUserId), "psnChange-tdkw.common.app-adminOrgIds");
        String isAdminOrgStr = HRUserRoleCacheUtils.getCache(String.valueOf(currentUserId), "psnChange-tdkw.common.app-isAdminOrg");
        ...
        if (kd.bos.util.StringUtils.isNotEmpty(isAdminOrgStr)) {
            ...
            // 将权限组织转为string对象
            String hasPerOrgStr = StringUtils.join(adminOrgIds, ",");
            // 将权限组织存入缓存
            HRUserRoleCacheUtils.putCache(String.valueOf(currentUserId), "psnChange-tdkw.common.app-adminOrgIds", hasPerOrgStr);
            HRUserRoleCacheUtils.putCache(String.valueOf(currentUserId), "psnChange-tdkw.common.app-isAdminOrg", String.valueOf(isAdmin));
        }
