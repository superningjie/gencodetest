package tdkw.esc.leaderquery.report.middleLeader;
...
public class SQLRightTablePlugin extends AbstractReportListDataPlugin {
    private static final Log logger = LogFactory.getLog(SQLRightTablePlugin.class);
    //todo 假实体待建
    private static final String entryNumber = "tdkw_middlelevelcadres_pc";
    ...
    private DataSet queryData(ReportQueryParam reportQueryParam) {
        ...
        //岗位层级=其他高管&中层
        levelQfilter.and("empposrel.tdkw_postlevel", QCP.equals, "3");
        levelQfilter.or("empposrel.tdkw_postlevel", QCP.equals, "4");
        ...
        if (null != reportQueryParam.getCustomParam().get("orgIds")) {
            ...
            if (!orgIds.contains(100000L)) {
                if( orgIds.size() == 1 ){
                    ...
                    logger.info("hrOrgIds的size" + hrOrgIds.size());
        ...
        //查人事业务档案 姓名,人员id,任职经历.所属公司,任职经历.所属部门,任职经历-岗位,任职经历-岗位层级,任职经历-开始日期
       ...
       /*
        ...
        //查询服务年限
        //DataSet hrpiPerserlenDataSet = QueryServiceHelper.queryDataSet(algoKey, "hrpi_perserlen", "person.id,tdkw_executivesdate,tdkw_mesospheredate,socialworkage,comsercount,tdkw_newjointime", new QFilter[]{personQfilter, perserlenQfilter}, null);
        DataSet hrpiPerserlenDataSet = QueryServiceHelper.queryDataSet(algoKey, "hrpi_perserlen", "person.id,tdkw_executivesdate,tdkw_mesospheredate,socialworkage,comsercount,tdkw_newjointime", new QFilter[]{personQfilter, perserlenQfilter}, null);
        //查询人员非时序性属性
        ...
        //todo 内连接服务年限
        finish = finish.leftJoin(hrpiPerserlenDataSet).on("person.id", "person.id").select("tdkw_number", "personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage", "comsercount", "tdkw_newjointime", "tdkw_index").finish();
        //finish = finish.leftJoin(hrpiPerserlenDataSet).on("person.id", "person.id").select("tdkw_number", "personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage", "comsercount", "tdkw_newjointime", "tdkw_index").finish();
        //todo 内连接人员非时序性属性
        //finish = finish.leftJoin(hrpiPernontspropDataSet).on("person.id", "person.id").select("tdkw_number", "personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage", "comsercount", "tdkw_newjointime", "gender", "address", "birthday", "age", "tdkw_index").finish();
        finish = finish.leftJoin(hrpiPernontspropDataSet).on("person.id", "person.id").select("tdkw_number", "personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage", "comsercount", "tdkw_newjointime", "gender", "address", "birthday", "age", "tdkw_index","pinyin").finish();
        //todo 内连接基本信息
        //finish = finish.leftJoin(baseDataSet).on("person.id", "person.id").select("tdkw_number", "personid", "ermanfileid", "name as tdkw_name", "person.id", "company as tdkw_company", "companylayer as tdkw_companylayer", "adminorg as tdkw_adminorg", "position as tdkw_position", "level as tdkw_level", "startdate as tdkw_startdate", "education as tdkw_education", "marriagestatus as tdkw_marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage as tdkw_socialworkage",      "comsercount as tdkw_comsercount", "gender as tdkw_gender", "address as tdkw_address", "birthday as tdkw_birthday", "age as tdkw_age", "politicalstatus as tdkw_politicalstatus", "tdkw_index").finish().orderBy(new String[]{"tdkw_index"});
        finish = finish.leftJoin(baseDataSet).on("person.id", "person.id").select("tdkw_number", "personid", "ermanfileid", "name as tdkw_name", "person.id", "company as tdkw_company", "companylayer as tdkw_companylayer", "adminorg as tdkw_adminorg", "position as tdkw_position", "level as tdkw_level", "startdate as tdkw_startdate", "education as tdkw_education", "marriagestatus as tdkw_marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage as tdkw_socialworkage", "tdkw_newjointime as tdkw_comsercount", "gender as tdkw_gender", "address as tdkw_address", "birthday as tdkw_birthday", "age as tdkw_age", "politicalstatus as tdkw_politicalstatus", "tdkw_index","pinyin").finish().orderBy(new String[]{"tdkw_index"});
...
//                        perserlenQfilter.and("comsercount", QCP.less_equals, value);
    ...
    private DataSet queryBatchData(ReportQueryParam reportQueryParam) {
        ...
        DataSet ermanfileDataSet = QueryServiceHelper.queryDataSet(algoKey, "hspm_ermanfile", "id as ermanfileid,name,person.tdkw_pkid as personid,person.id,empposrel.company.name as company,empposrel.company.adminorglayer.name as companylayer,empposrel.adminorg.name as adminorg,empposrel.position.name as position,empposrel.tdkw_postlevel as level,empposrel.startdate startdate,tdkw_index", new QFilter[]{erManFileQfilter, orgQfilter, levelQfilter}, null);
        //personFlow.addField("case when depemp.position.tdkw_displayvalue = '' then depemp.position.name else depemp.position.tdkw_displayvalue end as depemp.position.name", "depemp.position.name");
        DynamicObjectCollection ermanfileCollection = ORM.create().toPlainDynamicObjectCollection(ermanfileDataSet.copy());
        //拿出人员
        List<Long> personIds = ermanfileCollection.stream().map(i -> i.getLong("person.id")).collect(Collectors.toList());
        ...
        //todo 人事业务档案内连接教育经历
        DataSet finish = ermanfileDataSet.leftJoin(eduDataSet).on("person.id", "person.id").select("personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "tdkw_index").finish();
        //todo 内连接人员时序性属性
        finish = finish.leftJoin(hrpiPertspropDataSet).on("person.id", "person.id").select("personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "marriagestatus", "tdkw_index").finish();
        //todo 内连接服务年限
        //finish = finish.leftJoin(hrpiPerserlenDataSet).on("person.id", "person.id").select("personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage", "comsercount", "tdkw_newjointime", "tdkw_index").finish();
        finish = finish.leftJoin(hrpiPerserlenDataSet).on("person.id", "person.id").select("personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage", "comsercount", "tdkw_newjointime", "tdkw_index").finish();
        //todo 内连接人员非时序性属性
        //finish = finish.leftJoin(hrpiPernontspropDataSet).on("person.id", "person.id").select("personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage", "comsercount","tdkw_newjointime", "gender", "address", "birthday", "age", "tdkw_index").finish();
        finish = finish.leftJoin(hrpiPernontspropDataSet).on("person.id", "person.id").select("personid", "ermanfileid", "name", "person.id", "company", "companylayer", "adminorg", "position", "level", "startdate", "education", "marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage", "comsercount","tdkw_newjointime", "gender", "address", "birthday", "age", "tdkw_index","pinyin").finish();
        //todo 内连接基本信息
        //finish = finish.leftJoin(baseDataSet).on("person.id", "person.id").select("personid", "ermanfileid", "name as tdkw_name", "company as tdkw_company", "companylayer as tdkw_companylayer", "adminorg as tdkw_adminorg", "position as tdkw_position", "level as tdkw_level", "startdate as tdkw_startdate", "education as tdkw_education", "marriagestatus as tdkw_marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage as tdkw_socialworkage", "comsercount as tdkw_comsercount", "gender as tdkw_gender", "address as tdkw_address", "birthday as tdkw_birthday", "age as tdkw_age", "politicalstatus as tdkw_politicalstatus", "tdkw_index").finish().orderBy(new String[]{"tdkw_index"});
        finish = finish.leftJoin(baseDataSet).on("person.id", "person.id").select("personid", "ermanfileid", "name as tdkw_name", "company as tdkw_company", "companylayer as tdkw_companylayer", "adminorg as tdkw_adminorg", "position as tdkw_position", "level as tdkw_level", "startdate as tdkw_startdate", "education as tdkw_education", "marriagestatus as tdkw_marriagestatus", "tdkw_executivesdate", "tdkw_mesospheredate", "socialworkage as tdkw_socialworkage", "tdkw_newjointime as tdkw_comsercount", "gender as tdkw_gender", "address as tdkw_address", "birthday as tdkw_birthday", "age as tdkw_age", "politicalstatus as tdkw_politicalstatus", "tdkw_index","pinyin").finish().orderBy(new String[]{"tdkw_index"});
...
//                        perserlenQfilter.and("comsercount", QCP.less_equals, value);
    ...
    private QFilter getHasRightOrg(QFilter orgQfilter) {
        ...
        logger.info("领导查询-中层干部报表是否有所有权限:" + hasAllOrgPerm);
        if (!hasAllOrgPerm) {
