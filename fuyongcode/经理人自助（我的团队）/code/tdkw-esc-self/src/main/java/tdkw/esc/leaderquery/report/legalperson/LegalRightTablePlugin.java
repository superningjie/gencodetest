...
public class LegalRightTablePlugin extends AbstractReportListDataPlugin {
    private static final Log logger = LogFactory.getLog(LegalRightTablePlugin.class);
    // todo 假实体待建
    private static final String entryNumber = "tdkw_frgsggrz_pc";
    ...
    public DataSet query(ReportQueryParam reportQueryParam, Object o) throws Throwable {
        ...
        logger.info("法人公司高管报表query查询耗时:" + (end - start) + "毫秒");
        return dataSet;
    }
    ...
    private DataSet queryBatchData(ReportQueryParam reportQueryParam) {
        ...
        // 其他任职信息过滤
        QFilter otheremployinfQFilter = new QFilter("1", QCP.equals, 1);
        // 人事业务过滤
        ...
        versionControl(eduQfilter, perTsPropQfilter, pernontsprQfilter, politicalQfilter, erManFileQfilter, otheremployinfQFilter, perserlenQfilter);
        ...
        String otheremployinfData = "id as otheremployinfid,person.id,person.tdkw_pkid as personid,tdkw_company as tdkw_legalcompany,person.name tdkw_name,tdkw_post,tdkw_poststype,tdkw_startdate,tdkw_enddate,tdkw_tenure";
        ...
        return null;
       /* // 查询其他任职信息
        DataSet otheremployinfDataSet = QueryServiceHelper.queryDataSet(algoKey, "tdkw_hrpi_otheremployinf", otheremployinfData, new QFilter[]{specialQFilter, otheremployinfQFilter, queryQFilter}, null);
        ...
        DynamicObjectCollection attendrecordsCollection = ORM.create().toPlainDynamicObjectCollection(otheremployinfDataSet.copy());
        // 拿出人员
        ...
        // todo 其他任职信息左连接教育经历
        DataSet finish = otheremployinfDataSet.leftJoin(eduDataSet).on("person.id", "person.id").select("otheremployinfid", "person.id", "personid", "tdkw_legalcompany", "tdkw_name", "tdkw_post", "tdkw_poststype", "tdkw_startdate", "tdkw_enddate", "tdkw_tenure", "tdkw_education").finish();
        // todo 左连接人员时序性属性
        finish = finish.leftJoin(hrpiPertspropDataSet).on("person.id", "person.id").select("otheremployinfid", "person.id", "personid", "tdkw_legalcompany", "tdkw_name", "tdkw_post", "tdkw_poststype", "tdkw_startdate", "tdkw_enddate", "tdkw_tenure", "tdkw_education", "tdkw_marriagestatus").finish();
        // todo 左连接人员非时序性属性
        finish = finish.leftJoin(hrpiPernontspropDataSet).on("person.id", "person.id").select("otheremployinfid", "person.id", "personid", "tdkw_legalcompany", "tdkw_name", "tdkw_post", "tdkw_poststype", "tdkw_startdate", "tdkw_enddate", "tdkw_tenure", "tdkw_education", "tdkw_marriagestatus", "tdkw_address", "tdkw_birthday", "tdkw_gender", "tdkw_age", "tdkw_servicelen", "pinyin").finish();
        // todo 左连接基本信息
        finish = finish.leftJoin(baseDataSet).on("person.id", "person.id").select("otheremployinfid", "person.id", "personid", "tdkw_legalcompany", "tdkw_name", "tdkw_post", "tdkw_poststype", "tdkw_startdate", "tdkw_enddate", "tdkw_tenure", "tdkw_education", "tdkw_marriagestatus", "tdkw_address", "tdkw_birthday", "tdkw_politicalstatus", "tdkw_gender", "tdkw_age", "tdkw_servicelen", "pinyin").finish();
        //左连接服务年限
        finish = finish.leftJoin(hrpiPerserlenDataSet).on("person.id", "person.id").select("otheremployinfid", "person.id", "personid", "tdkw_legalcompany", "tdkw_name", "tdkw_post", "tdkw_poststype", "tdkw_startdate", "tdkw_enddate", "tdkw_tenure", "tdkw_education", "tdkw_marriagestatus", "tdkw_address", "tdkw_birthday", "tdkw_politicalstatus", "tdkw_gender", "tdkw_age", "tdkw_servicelen", "tdkw_newjointime", "pinyin").finish();
        // todo 内连接人事业务档案
        //finish = finish.join(ermanfileDataSet).on("person.id", "person.id").select("tdkw_number","otheremployinfid", "person.id", "personid", "tdkw_legalcompany", "tdkw_name", "tdkw_post", "tdkw_poststype", "tdkw_startdate", "tdkw_enddate", "tdkw_tenure", "tdkw_education", "tdkw_marriagestatus", "tdkw_address", "tdkw_birthday", "tdkw_politicalstatus", "tdkw_company", "tdkw_adminorg", "tdkw_gender", "tdkw_age", "tdkw_servicelen", "tdkw_newjointime as tdkw_entservicelen", "tdkw_index").finish().orderBy(new String[]{"tdkw_index"});
...
//        }
            ...
            switch (propName) {
                ...
                case "tdkw_position_filter":
                    ...
                    if (ObjectUtils.isNotEmpty(value)) {
                        ...
                        finish = finish.filter("tdkw_post in var", param);
                    }
    ...
    private QFilter getHasRightOrg(QFilter orgQfilter) {
        ...
        logger.info("领导查询-法人公司高管报表是否有所有权限:" + hasAllOrgPerm);
        if (!hasAllOrgPerm) {
    ...
    private static void versionControl(QFilter eduQfilter, QFilter perTsPropQfilter, QFilter pernontsprQfilter, QFilter politicalQfilter, QFilter erManFileQfilter, QFilter otheremployinfQFilter, QFilter perserlenQfilter) {
        // 教育经历
        ...
        // 其他任职信息
        otheremployinfQFilter.and("iscurrentversion", QCP.equals, "1");
        otheremployinfQFilter.and("datastatus", QCP.equals, "1");
        otheremployinfQFilter.and("tdkw_post.number", QCP.not_equals, "GGZW10");
        otheremployinfQFilter.and("tdkw_company", QCP.not_equals, null);
        // 服务年限
