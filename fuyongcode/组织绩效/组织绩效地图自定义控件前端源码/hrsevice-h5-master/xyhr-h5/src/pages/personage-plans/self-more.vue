                  ...
                  <div class="list-content">
                    ...
                    <div class="content-item">
                      <van-field name="finish" :rules="finish">
                        <template #input>
                          <van-radio-group
                            v-model="item.evaluateList[ind].selfResult"
                    ...
                    <div class="content-item">
                      <van-field
                        v-model="item.evaluateList[ind].selfResultDes"
                        :disabled="
                          ite.taskStatus == '待评价' ||
                          ite.taskStatus == '已评价'
                        "
...
<script>
import { selfEvaluation, EvaluateByList } from "@/libs/api.js";
export default {
  data() {
    return {
    ...
    handleSubmit() {
      this.$refs.form
        ...
        .then(() => {
          ...
          let selfData = this.evaluateArr.flatMap((item) =>
            item.evaluateList.map(({ id, selfResult, selfResultDes }) => ({
              taskId: id,
              selfResult,
              selfResultDes,
            }))
