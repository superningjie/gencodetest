        ...
        for (ExtendedDataEntity entity : dataEntities) {
            ...
            if (Objects.nonNull(org)) {
                ...
                QFilter qFilter = new QFilter("dgdl_org.number", QCP.equals, orgNumber)
                        ...
                        ;
                logger.info("PlanYearStartValidator查询语句" + qFilter);
