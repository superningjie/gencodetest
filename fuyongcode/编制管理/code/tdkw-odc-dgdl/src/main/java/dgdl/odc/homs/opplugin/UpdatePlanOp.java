...
public class UpdatePlanOp extends AbstractOperationServicePlugIn {
    private static Log logger = LogFactory.getLog(UpdatePlanOp.class);
    /**
     * 任职经历获取字段
     */
    ...
    public void beforeExecuteOperationTransaction(BeforeOperationArgs e) {
        ...
        DynamicObject[] planMonths = e.getDataEntities();
